...
public class FangchanLiuyanView extends FangchanLiuyanEntity implements Serializable {
	...
	public FangchanLiuyanView() {

	}

	public FangchanLiuyanView(FangchanLiuyanEntity fangchanLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, fangchanLiuyanEntity);
