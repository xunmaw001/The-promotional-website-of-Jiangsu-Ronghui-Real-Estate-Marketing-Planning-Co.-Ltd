    ...
    */
    ...
    public R save(@RequestBody FangchanEntity fangchan, HttpServletRequest request){
        ...
        Wrapper<FangchanEntity> queryWrapper = new EntityWrapper<FangchanEntity>()
            ...
            .eq("fangchan_louceng", fangchan.getFangchanLouceng())
            .eq("fangchan_mianji", fangchan.getFangchanMianji())
            ;
...
//                            fangchanEntity.setFangchanName(data.get(0));                    //新房名称 要改的
//                            fangchanEntity.setFangchanTypes(Integer.valueOf(data.get(0)));   //新房类型 要改的
//                            fangchanEntity.setFangchanPhoto("");//详情和图片
//                            fangchanEntity.setFangchanLouceng(data.get(0));                    //楼层 要改的
//                            fangchanEntity.setFangchanMianji(data.get(0));                    //面积 要改的
//                            fangchanEntity.setFangchanNewMoney(data.get(0));                    //价格 要改的
//                            fangchanEntity.setFangchanContent("");//详情和图片
