...
//            fangchanCollection.setYonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
    ...
    */
    ...
    public R save( String fileName, HttpServletRequest request){
        ...
        try {
            List<FangchanCollectionEntity> fangchanCollectionList = new ArrayList<>();//上传的东西
                ...
                if(!".xls".equals(suffix)){
                    ...
                    if(!file.exists()){
                        ...
                        for(List<String> data:dataList){
                            //循环
                            FangchanCollectionEntity fangchanCollectionEntity = new FangchanCollectionEntity();
//                            fangchanCollectionEntity.setFangchanId(Integer.valueOf(data.get(0)));   //新房 要改的
//                            fangchanCollectionEntity.setYonghuId(Integer.valueOf(data.get(0)));   //用户 要改的
//                            fangchanCollectionEntity.setFangchanCollectionTypes(Integer.valueOf(data.get(0)));   //类型 要改的
//                            fangchanCollectionEntity.setInsertTime(date);//时间
//                            fangchanCollectionEntity.setCreateTime(date);//时间
                            fangchanCollectionList.add(fangchanCollectionEntity);
                        ...
                        //查询是否重复
                        fangchanCollectionService.insertBatch(fangchanCollectionList);
                        return R.ok();
                    }
                }
            }
    ...
    */
    @RequestMapping("/add")
    public R add(@RequestBody FangchanCollectionEntity fangchanCollection, HttpServletRequest request){
        logger.debug("add方法:,,Controller:{},,fangchanCollection:{}",this.getClass().getName(),fangchanCollection.toString());
        Wrapper<FangchanCollectionEntity> queryWrapper = new EntityWrapper<FangchanCollectionEntity>()
            .eq("fangchan_id", fangchanCollection.getFangchanId())
            .eq("yonghu_id", fangchanCollection.getYonghuId())
            .eq("fangchan_collection_types", fangchanCollection.getFangchanCollectionTypes())
