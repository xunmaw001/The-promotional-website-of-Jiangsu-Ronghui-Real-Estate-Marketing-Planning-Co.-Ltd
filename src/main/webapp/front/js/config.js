var projectName = '江苏融汇房地产营销策划有限公司';
/**
 * 轮播图配置
 */
var swiper = {
...
var centerMenu = [
    ...
    ,{
        name: '新房收藏',
        url: '../fangchanCollection/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '团队信息',
        url: './pages/tuandui/list.html'
    },

]

var adminurl =  "http://localhost:8080/fangdicanxiaoshouyingxiao/admin/dist/index.html#/login";
